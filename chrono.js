...
exports.Parser = function ENMonthNameLittleEndianParser(){
    ...
    this.extract = function(text, ref, match, opt){
        ...
        if(year){
            result.start.assign('jour', day);
            result.start.assign('mois', month);
            result.start.assign('année', year);
        } else {
            ...
            result.start.assign('jour', day);
            result.start.assign('mois', month);
            result.start.imply('année', refMoment.year());
        }
        ...
        if (match[WEEKDAY_GROUP]) {
            ...
            result.start.assign('jour de la semaine', weekday);
        }

        // Text can be 'range' value. Such as '12 - 13 January 2012'
        if (match[DATE_TO_GROUP]) {
            result.end = result.start.clone();
            result.end.assign('jour', parseInt(match[DATE_TO_GROUP]));
        }
...
},{"../../result":25,"../../utils/FR":26,"../parser":16,"moment":1}],8:[function(require,module,exports){
/*
...
var PATTERN = new RegExp('(\\W|^)' +
    ...
    '\\s*,?\\s*)?' +
    '(Jan\\.?|Janvier|Fév\\.?|Février|Mar\\.?|Mars|Avr\\.?|Avril|Mai\\.?|Jun\\.?|Juin|Jul\\.?|Juillet|Aout\\.?|Aout|Sep\\.?|Sept\\.?|Septembre|Oct\\.?|Octobre|Nov\\.?|Novembre|Dec\\.?|Décembre)' +
    '\\s*' +
...
},{"../../result":25,"../../utils/FR":26,"../parser":16,"moment":1}],9:[function(require,module,exports){
/*
...
exports.Parser = function ENSlashDateFormatParser(argument) {
    ...
    this.extract = function(text, ref, match, opt){
        ...
        //Day of week
        if(match[WEEKDAY_GROUP]) {
            result.start.assign('jour de la semaine', DAYS_OFFSET[match[WEEKDAY_GROUP].toLowerCase()]);
        }
...
exports.Parser = function ENTimeExpressionParser(){
    ...
    this.extract = function(text, ref, match, opt){
        ...
        if(match[SECOND_GROUP] != null){
            ...
            result.start.assign('seconde', second);
        }
        ...
        result.start.assign('heure', hour);
        ...
        if(match[SECOND_GROUP] != null){
            ...
            result.end.assign('seconde', second);
        }
        ...
        if (match[AM_PM_HOUR_GROUP] != null){
            ...
            if (!result.start.isCertain('meridiem')) {
                if (meridiem == 0) {
                    ...
                    if (result.start.get('heure') == 12) {
                        result.start.assign('heure', 0);
                    }
                    ...
                    if (result.start.get('heure') != 12) {
                        result.start.assign('heure', result.start.get('heure') + 12);
                    }
                }
            }
        }
...
},{"./FR/ENCasualDateParser":4,"./FR/ENDeadlineFormatParser":5,"./FR/ENISOFormatParser":6,"./FR/ENMonthNameLittleEndianParser":7,"./FR/ENMonthNameMiddleEndianParser":8,"./FR/ENSlashDateFormatParser":9,"./FR/ENSlashDateFormatStartWithYearParser":10,"./FR/ENTimeAgoFormatParser":11,"./FR/ENTimeExpressionParser":12,"./FR/ENWeekdayParser":13,"./JP/JPCasualDateParser":14,"./JP/JPStandardParser":15}],17:[function(require,module,exports){
/*
